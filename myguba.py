...
for j in range(1,1749):
    print ("总共1749页，当前：",j,"  当前进度："'%.2f%%' % (j/1749 * 100))#可以借此估计爬取网页的进度:改进方向为进度条、百分数等
    url = 'http://guba.eastmoney.com/list,000100_'+str(j)+'.html'
    try:
        ...
        for i in range(0,80): ####从列表中提取，每个列表80个元素，index为0-79
            ...
            #保存
            book.save('C:\\Users\\mcc\\Desktop\\Python Learning Notes\\0001000.xls')
